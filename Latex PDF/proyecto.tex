...
\input{capitulos/02_SIG}
\input{capitulos/03_WebSemantica}
\input{capitulos/04_SIGyGeoSPARQL}
\input{capitulos/05_Aplicacion}
%\input{capitulos/05_Resultados}
\input{capitulos/06_Conclusiones}

\appendix
%\begin{appendices}
\input{capitulos/07_AnexosA}
\input{capitulos/07_AnexosC}
\input{capitulos/07_AnexosB}
%\end{appendices}

%\input{capitulos/07_AnexosD}

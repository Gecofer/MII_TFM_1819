...
\begin{itemize}
	...
	\item % hablar sobre la página esa que tiene Londres - London Data store
...
% El éxito de la web es la indefinida cantidad de documentos y recursos a los que podemos acceder desde cualquier parte del mundo, lo que nos ha llevado, eso sí, a una situación de desinformación y diferencias de formatos. Para solucionar estos dos principales problemas recurrimos a la web semántica, que permite a los usuarios delegar esas tareas al software que permite procesar el contenido, razonarlo y combinarlo.
%  la web semántica es una red de datos que puede ser procesada directa o indirectamente por máquinas. La información en la web se da con un significado bien definido, lo que facilita que ordenadores y personas trabajen en cooperación.
% En resumen,  lo que hace la web semántica  es ayudarnos en la búsqueda de un tema. Para ello utiliza métodos de representación del conocimiento mediante una red de nodos conectados entre sí, para no confundir temas parecidos.  Realmente busca lo que queremos buscar a través de un lenguaje universal estándar. La web se encarga de enseñar a los ordenadores a saber lo que queremos buscar, a partir de algoritmos que permiten marcar semánticamente los contenidos en cualquier documento textual.
